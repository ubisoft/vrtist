...
namespace VRtist
{
    public class ParametersEvent : UnityEvent<GameObject, Curve>
    {
    }
    ...
    public class AnimationController
    {
        ...
        private Dictionary<GameObject, Dictionary<Tuple<string, int>, Curve>> animationChannels = new Dictionary<GameObject, Dictionary<Tuple<string, int>, Curve>>();
