...
namespace VRtist
{
    ...
    public class UITimeBarRail : MonoBehaviour
    {
        public float width;
        public float height;
        ...
        public void RebuildMesh(float newWidth, float newHeight, float newThickness, float newMargin)
        {
            ...
            theNewMesh.name = "UITimeBarRail_GeneratedMesh";
        ...
        public static UITimeBarRail CreateUITimeBarRail(
            string objectName,
            Transform parent,
            ...
            Color c)
        {
            ...
            UITimeBarRail uiTimeBarRail = go.AddComponent<UITimeBarRail>();
            uiTimeBarRail.transform.parent = parent;
            uiTimeBarRail.transform.localPosition = parentAnchor + relativeLocation;
            uiTimeBarRail.transform.localRotation = Quaternion.identity;
            uiTimeBarRail.transform.localScale = Vector3.one;
            uiTimeBarRail.width = width;
            uiTimeBarRail.height = height;
            uiTimeBarRail.thickness = thickness;
            uiTimeBarRail.margin = margin;
            ...
            if (meshRenderer != null && material != null)
            {
                ...
                uiTimeBarRail.Color = c;

                meshRenderer.shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.Off;
                meshRenderer.renderingLayerMask = 2; // "LightLayer 1"
            }

            return uiTimeBarRail;
        }
    }
}
