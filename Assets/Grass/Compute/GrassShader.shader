        ...
        SubShader
        {
            ...
            #define _ENERGY_CONSERVING_SPECULAR 1
                ...
                SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                {
                    ...
                    surface.BaseColor = (_Lerp_0064276be16d4a85af37e45d4e838ef0_Out_3.xyz);
...
//                    //surface.BaseColor = lerp(0.01 * _Lerp_0064276be16d4a85af37e45d4e838ef0_Out_3.xyz + _BottomColor, _TopColor, unity_StereoEyeIndex);
//                    surface.BaseColor = lerp(_BottomColor, _TopColor, unity_StereoEyeIndex);
//#endif
                    surface.Emission = float3(0, 0, 0);
                    surface.Alpha = 1;
                    surface.BentNormal = IN.TangentSpaceNormal;
